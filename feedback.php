...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['content']) && $_POST['content'] != "") {
        ...
        /* Checking if the content is empty or not. */
        if (filter_input(INPUT_POST, 'content', FILTER_VALIDATE_EMAIL) && filter_input(INPUT_POST, 'name', FILTER_SANITIZE_SPECIAL_CHARS)) {
            ...
            $q = "INSERT INTO feedback (name, content) VALUES ('$name','$content')";
            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form" method="POST" autocomplete="off" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <div class="wrap-input100">
                        <input class="input100" autocomplete="off" type="text" name="email" placeholder="Your Name" required>
